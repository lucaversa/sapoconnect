...
// Height of hour cells in week view - controls the scale of time display
export const WeekCellsHeight = 64

// Height of hour cells in day view - keeps day view readable
export const DayCellsHeight = 72
