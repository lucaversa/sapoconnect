...
export function EventDialog({
  ...
  useEffect(() => {
    if (event) {
      ...
      setColor((event.color as EventColor) || "green")
  ...
  const handleDelete = () => {
    ...
    },
    {
      value: "green",
      label: "Verde",
      bgClass: "bg-primary data-[state=checked]:bg-primary",
      borderClass: "border-primary data-[state=checked]:border-primary",
    },
    {
      value: "amber",
      label: "Âmbar",
              ...
              <Popover open={startDateOpen} onOpenChange={setStartDateOpen}>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    >
                      {startDate ? format(startDate, "PPP", { locale: ptBR }) : "Escolher uma data"}
                    </span>
                    <RiCalendarLine
                      size={16}
              ...
              <Popover open={endDateOpen} onOpenChange={setEndDateOpen}>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    >
                      {endDate ? format(endDate, "PPP", { locale: ptBR }) : "Escolher uma data"}
                    </span>
                    <RiCalendarLine
                      size={16}
                      className="text-muted-foreground/80 shrink-0"
