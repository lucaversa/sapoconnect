# Participar do SapoConnect

O desenvolvimento e as publicações do SapoConnect são mantidos por Luca Janini. A melhor forma de participar é registrar uma sugestão ou um problema no GitHub para que a conversa permaneça pública e organizada.
