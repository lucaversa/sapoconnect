...
describe("frontend information architecture", () => {
  ...
  it("exposes an anonymous community pulse and GitHub feedback paths", () => {
    ...
    expect(pulse).toContain("atualizados às 00h e a cada 2 horas entre 05h e 23h")
    ...
    expect(pulseDialog).toContain("Atualizado às 00h e a cada 2 horas entre 05h e 23h")
